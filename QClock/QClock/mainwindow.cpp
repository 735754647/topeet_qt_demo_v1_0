    ...
    : QMainWindow(parent)
{
    ...
    this->setStyleSheet("QWidget{ border-image: url(Resource/image/day.jpg);}");
    ...
    /* 画笔参数初始化 */
    painPara.painterColor = QColor("#afef69");
...
//    else
//    {
//        this->setStyleSheet("QWidget{ border-image: url(Resource/image/night.jpg);}");
//    }
}
