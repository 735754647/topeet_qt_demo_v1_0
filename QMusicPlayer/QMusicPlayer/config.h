...
//主窗口默认背景
#define APP_CONFIG_MAINWINDOW_BACKGROUND_IMAGE  "QMainWindow{border-image:url(Resource/background/QBack.jpg)}"
...
#define SONGSLIST_STYLE                         "QListWidget{background-color: rgba(255, 255, 255, 10%);outline:none}"\
                                                ...
                                                "QListWidget::item:hover:active{background: qlineargradient(spread:repeat, x2:0, y2:1, x2:1, y2:0, stop:0 #4B0082, stop:0.25 #4B0082, stop:0.5 #800080, stop:1 #800080);}"
