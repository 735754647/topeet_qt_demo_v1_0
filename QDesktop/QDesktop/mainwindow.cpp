...
//    tab->setStyleSheet("border-top: 2px solid black;background:transparent");
    ...
    //clock
    systime1->setGeometry(0,0,depx,depy/15);//设置标签最小尺寸
    font.setPixelSize((float)depy/30);
    systime1->setFont(font);
    systime1->setAlignment(Qt::AlignRight);
    systime1->setStyleSheet("background:transparent;color:white");


    systime2->setGeometry(0,0,depx,depy/15);//设置标签最小尺寸
    font.setPixelSize((float)depy/30);
    systime2->setFont(font);
    systime2->setAlignment(Qt::AlignLeft);
...
void MainWindow::timerUpDate()
{
    ...
    systime2->setText(currentTime.toString(" yyyy-M-dd"));
...
void MainWindow::mainWindowInit()
{
    ...
    //主Wiget，用于设置背景
//    QPalette  pic;
//    pic.setBrush(QPalette::Background,QBrush(QPixmap(":./Resource/background/main8.jpg").scaled(this->size())));
//    this->setPalette(pic);
...
//    else
        mainWidget->setStyleSheet("border-image:url(Resource/background/main8.jpg)");
...
//    weatherPlate->setStyleSheet("border-image:transparent;background-color:transparent;");
    ...
    appWidgetParent->setGeometry((float)0/800*this->geometry().width(),(float)80/480*this->geometry().height(),
                                 this->geometry().width(),(float)400/480*this->geometry().height());
    appWidgetParent->setStyleSheet("border-image:transparent");

    appWidget = new QWidget(appWidgetParent);
    appWidget->setGeometry(0,0,
                           2*this->geometry().width(),(float)400/480*this->geometry().height());
    ...
    strList<<"音乐"<<"媒体"<<"天气"<<"浏览器"<<"时钟"<<"文件"<<"相机"
          <<"相册"<<"便签"<<"计算器"<<"日历"<<"录音"<<"LED"<<"温度"<<"测试";
    ...
    for(int i = 0; i < 15; i++){
        ...
        case 4://时钟
            ...
            break;
        case 5://文件
            loopWidgetArr[i]->setGeometry((float)25/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        case 6://相册
            loopWidgetArr[i]->setGeometry((float)180/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        case 7://计算器
            loopWidgetArr[i]->setGeometry((float)340/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        case 8://阅读
            loopWidgetArr[i]->setGeometry((float)500/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        case 9://记事本
            loopWidgetArr[i]->setGeometry((float)655/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        case 10://相机
        ...
        case 14://录音
            ...
            break;
        case 15://温度
            loopWidgetArr[i]->setGeometry((float)825/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        case 16://脚本测试
            loopWidgetArr[i]->setGeometry((float)980/800*this->geometry().width(),(float)200/480*this->geometry().height(),
                                          (float)120/800*this->geometry().width(),(float)170/480*this->geometry().height());
            break;
        default:
            break;
        ...
        iconPushButton[i]->setStyleSheet("border-image:url(Resource/icon/"+QString::number(i+1)+".png);background-color:transparent;outline:none;border-radius:8px;");
...
//                               (float)15/800*this->geometry().width(),(float)15/800*this->geometry().width());
    pageWidget[1]->setGeometry((float)450/800*this->geometry().width(),(float)415/480*this->geometry().height(),
                               (float)15/800*this->geometry().width(),(float)15/800*this->geometry().width());
