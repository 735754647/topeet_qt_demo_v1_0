...
QT_MOC_LITERAL(1, 8, 8), // "loadLink"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 3), // "url"
QT_MOC_LITERAL(4, 22, 8) // "openLink"

    },
    "webPage\0loadLink\0\0url\0openLink"
};
...
void webPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loadLink((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        case 1: _t->openLink((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&webPage::loadLink)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void webPage::loadLink(const QUrl & _t1)
{
