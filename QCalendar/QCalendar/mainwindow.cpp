    ...
    : QMainWindow(parent)
{
    ...
    parent_widget->setStyleSheet("QWidget{ background-color:#60619c; }");
    ...
    format.setForeground(QBrush(QColor("#60619c")));
    ...
    format.setBackground(QBrush(QColor("#60619c")));
    ...
    switch_year_month->setStyleSheet("QLabel{ color:#60619c; }");
    ...
    next_month->setGeometry((float)560/800*this->geometry().width(),
                            ...
                            (float)37/800*this->geometry().width(),
                            (float)37/800*this->geometry().width());
    prev_month->setStyleSheet("QPushButton{ border-image:url(:/icon/Resource/icon/prev_1.png); }"
                              "QPushButton:pressed {border-image: url(:/icon/Resource/icon/prev_1.png); }");
    next_month->setStyleSheet("QPushButton{ border-image:url(:/icon/Resource/icon/next_1.png); }"
